...
const BLOG = {
  ...
  NOTION_PAGE_ID: 'f0e3e2e1b80a4af990edfef033253479',
  ...
  AUTHOR: '挨踢牛马', // 您的昵称 例如 tangly1024
  BIO: '学挨踢，牛马程序员🍚', // 作者简介
  LINK: 'https://notion-next-omega-jet.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '挨踢, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/mnzcode', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=1944518589.mp3',
      cover: 'http://p1.music.126.net/-ruQWTEDt5tseFuShMSnXw==/109951167378106995.jpg?param=130y130'
    },
    {
      name: '王都グランセル',
